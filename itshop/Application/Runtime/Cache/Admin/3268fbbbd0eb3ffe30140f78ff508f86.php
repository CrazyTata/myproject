        ...
        <table class="tablelist">
            ...
            <tbody>
            	<?php if(is_array($goods_list)): foreach($goods_list as $key=>$vo): ?><tr>
                    ...
                    <td><img src="<?php echo (ltrim($vo["goods_small_logo"],'.')); ?>" style="width:50px;height:50px" /></td>
                    <td class='isdel'><?php echo ($vo["goods_isdel"]); ?></td>
                    <td>
                    	<a href="<?php echo U('photos', 'goods_id='.$vo['goods_id']);?>" class="tablelink">相册管理</a>&emsp;
                    	<a href="<?php echo U('editGoods', 'goods_id='.$vo['goods_id']);?>" class="tablelink">编辑</a>&emsp; 
